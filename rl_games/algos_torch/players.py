...
class PpoPlayerContinuous(BasePlayer):
    ...
    def run(self):
        ...
        n_object_dict = {'custom': 2, 'C': 16, 27: 27, 'poly': 162, 'non-convex': 40, 'cuboid': 1, 'cross': 5, 'ball': 1, 'block': 1, 'asymmetry': 172, 'duck': 1, 'giraffe': 1, 'symmetry': 1, 'designer-cube': 1, "cross_bmr": 1, "cross5": 1, "designer-cube2": 1, "cross_y": 1, "cross3": 1, "cross_t": 1, "designer-cube3": 1,
