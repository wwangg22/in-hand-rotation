GPUS=$1
CKPT=/home/william/Desktop/USC/in-hand-rotation/runs/baseline_LEAPHAND/S1.0_C0.0_M0.02025-08-20_11-49-29-3278/nn/last_baseline_LEAPHAND_ep_10000_rew_374.60107.pth
len=${#array[@]}
...
task.env.ablation_mode=no-pc experiment=baseline_LEAPHAND_rel_quat \
wandb_activate=True \
${EXTRA_ARGS}