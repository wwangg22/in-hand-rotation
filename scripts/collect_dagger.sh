...
NAME=last_baoding_ep_5300_rew_1268.9863
LOC=/home/william/Desktop/USC/in-hand-rotation/runs/baoding/baodingS1.0_C0.0_M0.02025-06-08_19-28-12-3278/nn
STUDENT_LOC=runs/student/bc-baoding-multimodplus-3
STUDENT_NAME=model_bc_10200
array=( $@ )
len=${#array[@]}
...
python ./isaacgymenvs/run_dagger.py headless=True \
...
distill.student_logdir=${STUDENT_LOC} \
distill.student_resume=${STUDENT_NAME} \
